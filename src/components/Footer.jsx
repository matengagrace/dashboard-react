 ...
 function Footer() {
   return (
     <div className="bg-white mt-3 rounded-lg p-2 ">
        <footer class="bg-white leading-1 ">
    
    <div class=" grid grid-cols-2 lg:mt-0 lg:grid-cols-5 mb-3">

        <ul class="col-span-2 flex justify-start gap-6 lg:col-span-5 sm:justify-end flex-wrap">
          <li>
    ...
    <div class="">
      <div class="sm:flex sm:justify-between">
        <p class="text-xs text-gray-500">&copy;2026. Mediabox. All rights reserved.</p>
