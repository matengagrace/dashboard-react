...
function ModaleEdit({isOpen,onClose}) {
  ...
  <div class="w-full max-w-md rounded-lg bg-white p-6 shadow-lg">
    <div class="flex items-start justify-between">
      <h2 id="modalTitle" class="text-xl font-bold bg-blue-600 p-1 rounded-lg w-full text-gray-100 sm:text-2xl">Modifier l'Utilisateur</h2>
    ...
    <div class="mt-4">
      ...
      <label for="Confirm" class="mt-4 block w-[400px]">
        ...
        <input type="text" id="Confirm" class="mt-0.5 w-full pl-2 h-[40px] rounded border border-gray-400 outline-0 shadow-sm sm:text-sm"/>
      </label>
      <label for="Confirm" class="mt-4 block w-[400px]">
        <span class="text-sm font-medium text-gray-700">
          Role:
        </span>
        <select name="" id="" class="mt-0.5 w-full h-[40px] rounded pl-2 border border-gray-400 outline-0 shadow-sm sm:text-sm">
      ...
      <label for="Confirm" class="mt-4 block w-[400px]">
        ...
        <select name="" id="" class="mt-0.5 w-full h-[40px] rounded border pl-2 border-gray-400 outline-0 shadow-sm sm:text-sm">
      ...
      <label for="Confirm" class="mt-4 block w-[400px]">
        ...
        <input type="date" id="Confirm" class="mt-0.5 w-full h-[40px] pl-2 rounded border border-gray-400 outline-0 shadow-sm sm:text-sm"/>
      </label>
