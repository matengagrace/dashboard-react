          ...
          {openNoti && (
            ...
            <div className="border-b-1 w-full text-sm border-gray-400 pb-2">
              <div className="flex justify-between items-center relative">
                <h2>Notification</h2>
                <p className="bg-blue-500 px-1 rounded-full text-[14px] text-white absolute top-0 left-[84px]">
                  3
                </p>
            ...
            <div className="text-[13px] font-semibold text-gray-700 border-t-1 border-gray-400 w-full text-center cursor-pointer hover:text-blue-700">Voir plus</div>
          </div>
          )}
        </div>
