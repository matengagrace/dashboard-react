...
function ModaleAfficherInfo({ isOpen, onClose }) {
  ...
  return (
    <div>
      ...
      >
        <div class="w-[700px] rounded-lg bg-white p-5 shadow-lg dark:bg-white flex flex-col justify-between relative">
          <h2 id="modalTitle" class="text-xl text-center font-bold rounded-lg text-gray-800 sm:text-2xl">
