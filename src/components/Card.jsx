  ...
  return (
    <div className="mb-6">
      <div class="grid grid-cols-1 gap-4 lg:grid-cols-4 lg:gap-8">
        <div class="h-35 rounded-2xl bg-white shadow-lg p-2.5 flex flex-col justify-between active:bg-green-700 hover:bg-green-700 hover:text-white transition-all duration-300">
        ...
        <div class="h-35 rounded-2xl bg-white shadow-lg p-2.5 flex flex-col justify-between hover:bg-green-700 active:bg-green-700 hover:text-white transition-all duration-300">
          <div className="flex items-center justify-between">
